...
(function($) {
	...
	$.fn.facebookReactions = function(options) {
		...
		var faces 	= '<img src="emoji/like.png" class="emoji" data-emoji-value="like" style="" />';
		
		faces = faces + '<img src="emoji/love.png" class="emoji" data-emoji-value="love" style="" />';
		
		faces = faces + '<img src="emoji/smile.png" class="emoji" data-emoji-value="haha" style="" />';
		
		faces = faces + '<img src="emoji/wow.png" class="emoji" data-emoji-value="wow" style="" />';
		
		faces = faces + '<img src="emoji/sad.png" class="emoji" data-emoji-value="sad" style="" />';
		
		faces = faces + '<img src="emoji/angry.png" class="emoji" data-emoji-value="angry" style="" />';
